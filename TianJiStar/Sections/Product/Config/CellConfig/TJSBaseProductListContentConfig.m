...
- (instancetype)init
{
    if (self = [super init])
    {
        ...
        _dict = @{
                  ...
                  @"ProductListCellContentView" :       [TJSProductListContentConfig new],
...
- (id<TJSProductListContentConfig>)configBy:(TJSProductInfo *)product
{
   ...
   //暂时只有一种cell，手动取text类型
    id<TJSProductListContentConfig>config = [_dict objectForKey:@"ProductListCellContentView"];
