//
//  ContractAddAddressCellFactory.m
//  TianJiCloud
//
...
@interface ContractAddAddressCellFactory ()

@property (nonatomic,strong)ContractAddAddressCellLayoutConfig *layoutConfig;

@end

@implementation ContractAddAddressCellFactory
...
- (instancetype)init{
    ...
    if(self){
        ...
        _layoutConfig = [[ContractAddAddressCellLayoutConfig alloc]init];
    }
