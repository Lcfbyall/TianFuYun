...
@interface SettingHomeCellFactory ()

@property (nonatomic,strong)SettingHomeCellLayoutConfig *layoutConfig;

@end

@implementation SettingHomeCellFactory
...
- (instancetype)init{
    ...
    if(self){
        ...
        _layoutConfig = [[SettingHomeCellLayoutConfig alloc]init];
    }
