...
//                        }];
            ...
            [weakSelf.photoImageView setImageWithURLRequest:[NSURLRequest requestWithURL:photo.photoURL] placeholderImage:nil success:^(NSURLRequest * _Nonnull request, NSHTTPURLResponse * _Nullable response, UIImage * _Nonnull image) {
                if (image) {
