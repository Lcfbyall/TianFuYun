...
@interface AddressSelectedCellFactory ()

@property (nonatomic,strong)AddressSelectedCellLayoutConfig *layoutConfig;

@end

@implementation AddressSelectedCellFactory
...
- (instancetype)init{
    ...
    if(self){
        ...
        _layoutConfig = [[AddressSelectedCellLayoutConfig alloc]init];
    }
