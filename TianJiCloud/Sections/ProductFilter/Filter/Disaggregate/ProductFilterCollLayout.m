...
- (nullable UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(layoutAttribute.representedElementCategory == UICollectionElementCategoryCell)
    {
        if(indexPath.section == 0){
            ...
            CGFloat interMargin = self.interMargin;
            ...
            if(indexPath.item == 0 ){
                ...
                CGRectMake(lastAttribute.frame.origin.x + lastAttribute.frame.size.width + interMargin,
                           
                           lastAttribute.frame.origin.y + lastAttribute.frame.size.height + insets.top,
                           size.width,
                           size.height);
    ...
    else if (layoutAttribute.representedElementCategory == UICollectionElementCategorySupplementaryView){
    ...
    }else if (layoutAttribute.representedElementCategory == UICollectionElementCategoryDecorationView){
